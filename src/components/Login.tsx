                ...
                <div className="bg-white rounded-2xl shadow-2xl p-8 sm:p-10 transition-all duration-300 hover:shadow-3xl">
                    ...
                    <div className="text-center mb-8 animate-fade-in-up">
                        ...
                        <p className="text-gray-600 leading-relaxed">
                            Masuk ke akun Anda untuk menjelajahi UMKM terbaik di Indonesia
                        </p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        {/* Forgot Password */}
                            <a href="#" className="text-sm font-medium text-[#730700] hover:text-[#5a0500] transition-colors duration-300">
                                Lupa Password?
                            </a>
                    ...
                    <div className="text-center mt-8">
                        <p className="text-gray-600">
                            Belum punya akun?{' '}
                            <Link to="/register" className="font-semibold text-[#730700] hover:text-[#5a0500] transition-colors duration-300">
                                Daftar sekarang!
                            </Link>
                        </p>
                    </div>
