          ...
          <div>
            ...
            <div>
              ...
              <ul className="space-y-1 sm:space-y-2">
                ...
                <li><a href="#telp" className="text-[#B8B8B8] hover:text-white text-sm sm:text-base">+62 812 3456 7890</a></li>
                <li><a href="#lokasi" className="text-[#B8B8B8] hover:text-white text-sm sm:text-base">Jakarta, Indonesia.</a></li>
              </ul>
            </div>
          </div>
