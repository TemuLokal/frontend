            ...
            <form className="md:w-[50%] w-full" method="POST">
                ...
                <div className="pt-4 w-full">
                    <div className="w-full flex items-center bg-white rounded-[10px] shadow border border-[#E8E8EB] px-4 sm:px-5 py-3 sm:py-4 my-4 sm:gap-2">
                        <img className="w-5 h-5 sm:w-6 sm:h-6 text-[#B08B8B] mr-3" src="/user.svg" />
                        <input
                            type="text"
                    ...
                    <div className="w-full flex items-center bg-white rounded-[10px] shadow border border-[#E8E8EB] px-4 sm:px-5 py-3 sm:py-4 my-4 sm:gap-2">
                        ...
                        <input
                            ...
                            className="w-full bg-transparent outline-none text-sm sm:text-base md:text-lg"
                        />
                        <button type="button" onClick={() => setShowConfirmPassword(!showConfirmPassword)} className="focus:outline-none cursor-pointer">
                            {showConfirmPassword ? (
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" 
                                    viewBox="0 0 24 24" fill="none" stroke="#71717B" 
                                    strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" 
                ...
                <div className="pt-4">
                    <button className="w-full font-bold text-center bg-[#730700] text-white outline-none text-sm sm:text-base md:text-lg px-4 sm:px-5 py-3 sm:py-4 rounded-[10px] shadow cursor-pointer" type="submit">Daftar</button>
                </div>
                ...
                <div className="text-center pt-8">
                    <p className="text-[#71717B]">Sudah punya akun? <a href="/login" className="text-[#730700] font-semibold">Masuk sekarang!</a></p>
                </div>
            </form>
        </section>
    )
